...
class ModernDualComparator:
    ...
    def create_model_card(self, parent):
        ...
        self.pt_btn = tk.Button(pt_section, text="Select .pt Model", 
                               font=('SF Pro Display', 11), 
                               bg='#ffffff', fg='#2c3e50',
                               relief='solid', bd=1, padx=15, pady=8,
                               cursor='hand2', command=self.select_pt_model)
        ...
        self.onnx_btn = tk.Button(onnx_section, text="Select .onnx Model", 
                                 font=('SF Pro Display', 11), 
                                 bg='#ffffff', fg='#2c3e50',
                                 relief='solid', bd=1, padx=15, pady=8,
                                 cursor='hand2', command=self.select_onnx_model)
    ...
    def create_video_card(self, parent):
        ...
        self.video_btn = tk.Button(video_section, text="📁 Select Video", 
                                  font=('SF Pro Display', 11), 
                                  bg='#ffffff', fg='#2c3e50',
                                  relief='solid', bd=1, padx=15, pady=8,
                                  cursor='hand2', command=self.select_video)
        ...
        self.stop_btn = tk.Button(control_frame, text="⏹ Stop", 
                                 ...
                                 bg='#e74c3c', fg='#ffffff',
                                 relief='flat', bd=0, padx=15, pady=8,
                                 cursor='hand2', command=self.stop_video)
    ...
    def video_loop(self):
        ...
        self.cap = None
        self.is_playing = False
        self.root.after(0, lambda: self.play_btn.config(text="▶ Play", bg='#27ae60'))
